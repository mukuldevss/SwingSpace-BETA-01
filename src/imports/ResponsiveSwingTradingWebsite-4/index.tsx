import svgPaths from "./svg-mfdmj8r5if";

function Heading() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 1">
      <p className="[word-break:break-word] font-['Outfit:ExtraBold',sans-serif] font-extrabold leading-[28.6px] relative shrink-0 text-[#0c0c0b] text-[26px] tracking-[-0.78px] whitespace-nowrap">Portfolio Overview</p>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="content-stretch flex flex-col h-[24px] items-start pt-[4px] relative shrink-0 w-[1236px]" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#585856] text-[13px] whitespace-nowrap">Tuesday, 25 August 2026</p>
    </div>
  );
}
...
function Container2() {
  return (
    <div className="bg-white content-center flex flex-wrap gap-[16px_0px] items-center justify-center relative shrink-0 w-full" data-name="Container">
      <StatCard />
...
function Container7() {
  return <div className="bg-[#007a5e] h-[90px] min-w-[67px] opacity-85 relative shrink-0 w-[67px]" data-name="Container" />;
}

function Container8() {
  return <div className="bg-[#007a5e] h-[72px] min-w-[67px] opacity-85 relative shrink-0 w-[67px]" data-name="Container" />;
}

function Container9() {
  return <div className="bg-[#c12020] h-[40px] min-w-[67px] opacity-85 relative shrink-0 w-[67px]" data-name="Container" />;
}

function Container10() {
  return <div className="bg-[#007a5e] h-[63px] min-w-[67px] opacity-85 relative shrink-0 w-[67px]" data-name="Container" />;
}
...
function Container4() {
  return (
    <div className="bg-white col-1 content-stretch flex flex-col items-start justify-self-stretch p-[28px] relative row-1 self-stretch shrink-0" data-name="Container">
      <Container5 />
      <PnlBarChart />
    </div>
  );
  ...
  return (
    <div className="h-[80px] relative shrink-0 w-[552px]" data-name="CumulativeLine">
      <svg className="absolute block inset-0 size-full" fill="none" height="80" preserveAspectRatio="none" viewBox="0 0 552 80" width="552">
        <g clipPath="url(#clip0_0_17)" id="CumulativeLine">
...
function Container11() {
  return (
    <div className="bg-white col-2 content-stretch flex flex-col items-start justify-self-stretch p-[28px] relative row-1 self-stretch shrink-0" data-name="Container">
      <Container12 />
...
function Text1() {
  return (
    <div className="bg-[#008f6e] content-stretch flex items-center px-[8px] py-[2px] relative shrink-0" data-name="Text">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[16.5px] not-italic relative shrink-0 text-[11px] text-white tracking-[0.44px] uppercase whitespace-nowrap">4</p>
    </div>
  );
}
...
function Container15() {
  return (
    <div className="border-[#cccbc6] border-b border-solid content-stretch flex items-center justify-between px-[28px] py-[20px] relative shrink-0 w-full" data-name="Container">
      <Paragraph20 />
      <Text1 />
    </div>
  );
...
function TableRow4() {
  return (
    <div className="absolute border-[#cccbc6] border-b border-solid h-[49px] left-0 top-[186.5px] w-[1234px]" data-name="Table Row">
      <Container23 />
...
function Dashboard() {
  return (
    <div className="content-stretch flex flex-col h-[1128px] items-start pt-[24px] relative shrink-0 w-[1236px]" data-name="Dashboard">
      <Container2 />
      <ContainerMargin />
      <ContainerMargin1 />
      <ContainerMargin2 />
...
function Container() {
  return (
    <div className="content-stretch flex flex-[1338.492_0_0] flex-col items-start max-w-[1300px] min-h-px pb-[64px] pt-[96px] px-[32px] relative w-[1300px]" data-name="Container">
      <Container1 />
      <Dashboard />
    </div>
  );
...
function Paragraph23() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Paragraph">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[16.5px] not-italic relative shrink-0 text-[#585856] text-[11px] whitespace-nowrap">Data via Twelve Data · For educational use only</p>
    </div>
  );
}
...
function Footer() {
  return (
    <div className="border-[#cccbc6] border-solid border-t content-stretch flex flex-col h-[61px] items-start px-[24px] py-[20px] relative shrink-0 w-full" data-name="Footer">
      <ContainerMargin3 />
    </div>
  );
}
...
function App() {
  return (
    <div className="bg-[#edece8] content-stretch flex flex-col h-[1459.492px] items-center min-h-[870px] relative shrink-0 w-full" data-name="App">
      <Container />
      <FooterMargin />
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" height="16" preserveAspectRatio="none" viewBox="0 0 16 16" width="16">
        <g id="Icon">
          <path d="M2 12L6 7L9 10L13 4" id="Vector" stroke="#008F6E" strokeLinecap="square" strokeWidth="2" />
          <path d="M11 4H13V6" id="Vector_2" stroke="#008F6E" strokeLinecap="square" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function Text15() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0" data-name="Text">
      <p className="[word-break:break-word] font-['Outfit:Bold',sans-serif] font-bold leading-[0] relative shrink-0 text-[#0c0c0b] text-[17px] text-center tracking-[-0.34px] whitespace-nowrap">
        <span className="leading-[25.5px]">Swing</span>
        <span className="leading-[25.5px] text-[#008f6e]">Space</span>
      </p>
    </div>
  );
}
...
function Button1() {
  return (
    <div className="absolute border-[#008f6e] border-b-2 border-solid content-stretch flex flex-col h-[33.5px] items-center justify-center left-0 py-[6px] top-0" data-name="Button">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[19.5px] not-italic relative shrink-0 text-[#0c0c0b] text-[13px] text-center tracking-[0.13px] whitespace-nowrap">Dashboard</p>
    </div>
  );
}
...
function Button2() {
  return (
    <div className="absolute border-[rgba(0,0,0,0)] border-b-2 border-solid content-stretch flex flex-col h-[33.5px] items-center justify-center left-0 py-[6px] top-0" data-name="Button">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#585856] text-[13px] text-center tracking-[0.13px] whitespace-nowrap">Positions</p>
    </div>
  );
}
...
function Button3() {
  return (
    <div className="absolute border-[rgba(0,0,0,0)] border-b-2 border-solid content-stretch flex flex-col h-[33.5px] items-center justify-center left-0 py-[6px] top-0" data-name="Button">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#585856] text-[13px] text-center tracking-[0.13px] whitespace-nowrap">New Position</p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[15px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" height="15" preserveAspectRatio="none" viewBox="0 0 15 15" width="15">
        <g id="Icon">
          <path d="M7.5 1V10M4 7L7.5 10.5L11 7" id="Vector" stroke="#585856" strokeLinecap="square" strokeWidth="1.5" />
          <path d="M2 11V13H13V11" id="Vector_2" stroke="#585856" strokeLinecap="square" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function Button4() {
  return (
    <div className="border border-[#cccbc6] border-solid content-stretch flex items-center justify-center relative shrink-0 size-[34px]" data-name="Button">
      <Icon2 />
    </div>
  );
}
    ...
    <div className="relative shrink-0 size-[15px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" height="15" preserveAspectRatio="none" viewBox="0 0 15 15" width="15">
        <g clipPath="url(#clip0_0_9)" id="Icon">
          <path d="M7.5 10V1M4 4L7.5 0.5L11 4" id="Vector" stroke="#585856" strokeLinecap="square" strokeWidth="1.5" />
          <path d="M2 11V13H13V11" id="Vector_2" stroke="#585856" strokeLinecap="square" strokeWidth="1.5" />
        </g>
        <defs>
    ...
    <div className="relative shrink-0 size-[15px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" height="15" preserveAspectRatio="none" viewBox="0 0 15 15" width="15">
        <g clipPath="url(#clip0_0_4)" id="Icon">
          <path d={svgPaths.p29760000} id="Vector" stroke="#585856" strokeWidth="1.5" />
        </g>
        <defs>
...
function Header() {
  return (
    <div className="absolute bg-white border-[#cccbc6] border-b border-solid content-stretch flex flex-col items-start left-0 shadow-[0px_1px_0px_0px_#cccbc6,0px_2px_8px_0px_rgba(0,0,0,0.06)] top-0 w-[1387px]" data-name="Header">
      <ContainerMargin4 />
    </div>
  );
}
...
export default function ResponsiveSwingTradingWebsite() {
  return (
    <div className="bg-[#edece8] content-stretch flex flex-col items-start relative size-full" data-name="Responsive Swing Trading Website">
      <App />
      <Header />
    </div>
  );
